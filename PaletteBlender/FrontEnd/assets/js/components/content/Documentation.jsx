...
export default function Documentation(props) {
    return (
        <div className="content doc-content">
            ...
            <p>
                Color palettes in Palette Blender follow the common pattern of being made up of a primary color (and sometimes a secondary color) along with a set grays and contextual colors to provide visual cues. To read more about this approach, check out the guide section.
            </p>
            ...
            <div className="doc-image">
                <img src={STATIC_PREFIX + 'PaletteBlender/images/docs/pb_editor.png'} alt="The Palette Blender editor" />
            </div>
            ...
            <div className="doc-image doc-img-med">
                <img src={STATIC_PREFIX + 'PaletteBlender/images/docs/pb_sub_palette_selector.png'} alt="The sub-palette selector section of the Palette Blender editor" />
            </div>
            <p>
            ...
            <p>
                The Reset button will reset all unlocked shades in the currently selected sub-palette back to the original values.
            </p>
            ...
            <div className="doc-image doc-img-med">
                <img src={STATIC_PREFIX + 'PaletteBlender/images/docs/pb_color_selector.png'} alt="The color selector section of the Palette Blender editor" />
            </div>
            <p>
            ...
            <div className="doc-image doc-img-med">
                <img src={STATIC_PREFIX + 'PaletteBlender/images/docs/pb_shades_editor.png'} alt="The shades editor tool of the Palette Blender editor" />
            </div>
            <p>
            ...
            <div className="doc-image doc-img-med">
                <img src={STATIC_PREFIX + 'PaletteBlender/images/docs/pb_color_widget.png'} alt="The color widget tool of the Palette Blender editor" />
            </div>
        </div>
    );
}